---
title: "Antioxidants Explained: The Biohacker's Guide to Free Radicals, ROS, and Oxidative Stress"
date: 2024-01-23
draft: false
guide_type: "Nutrients 101"
tagline: "Move beyond the marketing hype—understand when oxidative stress kills performance and when it's the stimulus that makes you stronger."
key_points:
  - "Free radicals are not inherently bad; they're signaling molecules that trigger adaptation—the body adapts by building antioxidant defenses"
  - "Excessive antioxidant supplementation blunts training stimulus and impairs performance gains; more is not better"
...
**Why They're Called ROS (Reactive Oxygen Species):**
Most free radicals in your body are oxygen-derived, hence "reactive oxygen species."
...
**Enzymatic Antioxidants** (Most Important)
These enzymes neutralize free radicals by catalyzing their conversion to harmless molecules:
...
**Non-Enzymatic Antioxidants** (Supporting Actors)
These donate electrons to free radicals, converting them to stable molecules:
...
| Antioxidant | Type | Mechanism | Food Sources | Bioavailability | Supplement Form |
|-------------|------|-----------|--------------|-----------------|-----------------|
| **SOD** | Enzymatic | Converts O₂⁻ to H₂O₂ | Cannot consume directly; upregulate via exercise | N/A (endogenous) | SOD supplements poorly absorbed; worthless |
| **Catalase** | Enzymatic | Converts H₂O₂ to H₂O + O₂ | Organ meats, seaweed | N/A (endogenous) | Catalase supplements not absorbed |
| **Glutathione Peroxidase** | Enzymatic | Converts H₂O₂ + organic peroxides to water | Selenium; upregulate via training | N/A (endogenous) | GPx supplements not absorbed |
| **Glutathione (GSH)** | Non-enzymatic | Electron donor; cofactor for glutathione peroxidase | Undenatured whey, grass-fed beef, avocado | Poor (destroyed by stomach acid) | Liposomal glutathione has better absorption |
| **Vitamin C** | Non-enzymatic | Electron donor; recycler of vitamin E | Citrus, peppers, kiwi, broccoli | Saturable; ~500 mg/dose | Ascorbic acid, sodium ascorbate, time-release |
| **Vitamin E** | Non-enzymatic | Lipid antioxidant; protects membranes | Nuts, seeds, olive oil, avocado | Improves with fat intake | Mixed tocopherols (superior to isolated alpha) |
| **CoQ10** | Non-enzymatic | Mitochondrial antioxidant | Fatty fish, organ meats, nuts | Low (~5% oral); lipid formulations better | Ubiquinol (reduced form) better than ubiquinone |
| **Alpha-Lipoic Acid (ALA)** | Non-enzymatic | Recycled antioxidant; regenerates C, E, GSH, CoQ10 | Red meat, spinach, broccoli | 30-40% absorption | R-Alpha-Lipoic Acid (R-form) more active |
| **Resveratrol** | Polyphenol | Polyphenol; NRF2 activation | Red wine, red grapes, berries | 20-30% absorption; improved with quercetin | Trans-Resveratrol (bioavailable form) |
| **EGCG (Green Tea)** | Polyphenol | NRF2 activation; catechin antioxidant | Green tea, white tea | Varies; extract more concentrated | Green tea extract standardized to EGCG |
| **Quercetin** | Polyphenol | Antioxidant; enhances resveratrol absorption | Onions, apples, berries, capers | 3-17% absorption; enhanced by fat and vitamin C | Quercetin dihydrate or aglycone form |
| **Anthocyanins** | Polyphenol | Berry pigment antioxidants; NRF2 activation | Blueberries, blackberries, raspberries | Absorbed intact (20-60%) | Anthocyanin extract |
| **Astaxanthin** | Carotenoid | Xanthophyll antioxidant; potent lipid protection | Salmon, krill, algae (Haematococcus pluvialis) | Fat-soluble; absorbed with fat | Astaxanthin from algae (better than synthetic) |
| **Zeaxanthin** | Carotenoid | Macular pigment; eye protection | Egg yolks, corn, kale | Fat-soluble; absorbed with fat | Dietary sources preferred |
| **N-Acetylcysteine (NAC)** | Amino acid | Glutathione precursor; donates cysteine | Garlic, onions, cruciferous vegetables | Supplements better absorbed than food | N-Acetylcysteine powder or capsules |
