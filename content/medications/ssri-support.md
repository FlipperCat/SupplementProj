---
title: "SSRI Support: Supplements to Take Alongside Antidepressants"
date: 2024-01-17
draft: false
tagline: "Evidence-based supplements that may enhance antidepressant therapy and reduce side effects"
supplements:
  - "Omega-3"
  - "Vitamin D3"
  - "Magnesium"
...
recommended:
  ...
  - name: "Methylated B-Complex"
    dose: "1 daily"
  - name: "Probiotics"
    dose: "Multi-strain, 10+ billion CFU"
avoid: "St. John's Wort (serotonin syndrome risk), 5-HTP (serotonin syndrome risk), high-dose L-tryptophan, SAMe without medical supervision, excessive caffeine."
tags:
  - "depression"
  - "SSRI"
  - "antidepressants"
...
**Potential benefit**: Strong evidence for antidepressant effects
**Risk**: Can increase serotonin; serotonin syndrome possible
**Status**: ONLY with physician supervision

### Rhodiola

**Potential benefit**: Adaptogen with antidepressant properties
**Risk**: Minor MAO inhibition (theoretical concern)
**Status**: Generally considered safe, but discuss with doctor

### Curcumin (Turmeric)

**Potential benefit**: Anti-inflammatory, may improve depression
**Risk**: Low
**Status**: Generally safe to add
