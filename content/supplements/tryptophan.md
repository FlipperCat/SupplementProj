...
tagline: "Essential amino acid and serotonin precursor for mood, sleep, and immune support"
research_backed: true

dosage: "1-5g daily"
timing: "Evening 1-2 hours before bed, with carbohydrates; on empty stomach for sleep"
form: "Capsules or powder"
results_timeline: "3-7 days for sleep; 2-3 weeks for mood effects"
food: "Take with carbohydrates (banana, rice, juice); avoid protein meals"

timeline:
  - time: "1-3 days"
    effect: "Improved sleep onset; deeper sleep; relaxed mood"
  - time: "Week 1-2"
    effect: "Sustained sleep quality improvements; mood becoming more stable"
  - time: "Week 2-3"
    effect: "Reduced anxiety baseline; improved emotional resilience; daytime mood elevation"
  - time: "Week 3-4"
    effect: "Full therapeutic mood effects; normalized sleep-wake cycle; appetite normalization"
  - time: "Month 2+"
    effect: "Long-term mood stabilization; sustained sleep improvements; immune support"

synergies:
  - "Carbohydrates (critical)"
  - "Vitamin B6"
  - "Magnesium"
  - "Niacin"
  - "Glycine"
