...
tagline: "Dopamine and catecholamine precursor for focus, motivation, and stress adaptation"
research_backed: true

dosage: "500mg-3g daily"
timing: "Morning on empty stomach or with light meal; away from protein for optimal effect"
form: "Powder or capsules"
results_timeline: "30 minutes to 2 hours (acute); 1-2 weeks (sustained)"
food: "Take on empty stomach or with light carbohydrates; away from protein meals"

timeline:
  - time: "30-120 minutes"
    effect: "Acute focus and motivation increase; improved mental clarity; alertness"
  - time: "2-4 hours"
    effect: "Sustained dopamine elevation; improved mood and motivation; better stress resilience"
  - time: "Week 1-2"
    effect: "Improved baseline motivation and focus; better mood stability; enhanced performance"
  - time: "Week 2-4"
    effect: "Sustained cognitive enhancement; improved stress adaptation; better emotional regulation"
  - time: "Month 2+"
    effect: "Long-term improvements in motivation, focus, and stress resilience"
...
6. **Thyroid Function** (important biohacker consideration):
...
**Effects on thyroid**:
1. **Enhanced thyroid hormone synthesis**: More tyrosine + adequate iodine = potentially more T4 and T3 production
2. **Enhanced conversion**: Tyrosine may support T4 → T3 conversion (via peripheral conversion enzymes)
3. **Thyroid upregulation**: Some evidence suggests tyrosine supplementation enhances thyroid sensitivity
